...
- [✍🏻 Скрипт для создания рейда](#-скрипт-для-создания-raid-1)
- [🧱 Разметка и подготовка диска](#-разметка-и-подготовка-диска)
- [🗃️ RAID 1](#️-настройка-raid-1-с-использованием-mdadm)
- [💥 Симуляция отказа диска](#-симуляция-отказа-диска-в-raid-1-и-его-замена)
- [🛠️ RAID 1 без потери данных](#-cоздание-raid-1-без-потери-данных)
...
## 🗃️ Настройка RAID 1 с использованием mdadm
