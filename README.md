...
Результат:   
• Cкрипт для создания RAID 1 написан. Результат см. на скриншотах [create_RAID_1_1](https://github.com/kamil1403/otus_mdadm_RAID/blob/main/screenshots/create_RAID_1_1.png) и "create_RAID_1_2"   
